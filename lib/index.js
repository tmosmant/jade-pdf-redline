...
function jadepdf(options) {
  ...
  if (options.header.path)
    jadeHeader = juice.inlineContent(jade.renderFile(options.header.path, options.locals), css);
  var jadeFooter = '';
  if (options.footer.path)
    jadeFooter = juice.inlineContent(jade.renderFile(options.footer.path, options.locals), css);
